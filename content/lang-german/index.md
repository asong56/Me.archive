---
title: German
description: Comprehensive German grammar, verb tables, and vocabulary.
tags:
  - language
  - german
---
...
*Each entry: Infinitive → Perfekt · Type (Strong / Weak / Mixed) · Meaning. Sorted A–Z within each group.*
...
| **umkommen** | ist umgekommen | Strong | to perish |
| **wachsen** | ist gewachsen | Strong | to grow |
| **werden** | ist geworden | Strong | to become |
| **zittern** | hat gezittert | Weak | to tremble |

### 2. Communication, Thought & Expression
...
| **aufbauen** | hat aufgebaut | Weak | to build |
...
| **überqueren** | hat überquert | Weak | to cross |

### 4. Social Interaction, Emotions & Wishes
...
| **schaffen** | hat geschafft | Weak | to manage / create |
| **schicken** | hat geschickt | Weak | to send |
| **träumen** | hat geträumt | Weak | to dream |
| **wählen** | hat gewählt | Weak | to choose / vote |
...
| **abspielen** | hat abgespielt | Weak | to play (media) |
| **bestehen** | hat bestanden | Strong | to pass (an exam) |
| **bezahlen** | hat bezahlt | Weak | to pay |
| **dauern** | hat gedauert | Weak | to last |
| **erben** | hat geerbt | Weak | to inherit |
| **fressen** | hat gefressen | Strong | to eat (animals) |
...
| **schützen** | hat geschützt | Weak | to protect |
| **sich erinnern** | hat sich erinnert | Weak | to remember |
| **sich verstecken** | hat sich versteckt | Weak | to hide oneself |
| **stechen** | hat gestochen | Strong | to sting |
| **stellen** | hat gestellt | Weak | to place |
| **trinken** | hat getrunken | Strong | to drink |
| **übertragen** | hat übertragen | Strong | to transfer |
| **verlieren** | hat verloren | Strong | to lose |
| **verpassen** | hat verpasst | Weak | to miss (a train/event) |
...
*Article · Genitive · Plural · Meaning. Sorted A–Z.*

| Word | Gen. / Pl. | Meaning |
| :--- | :--- | :--- |
| **der Abgeordnete** *[ein Abgeordneter]* | -n | politician / MP *(Adjectival Noun)* |
| **die Aufgabe** | –, -n | task |
| **der Aufzug** | -(e)s, ⸚e | elevator |
| **der Baumstamm** | -(e)s, ⸚e | tree trunk / log |
| **der Briefumschlag** | -(e)s, ⸚e | envelope |
| **das Dach** | -(e)s, ⸚er | roof |
| **die Etage** | –, -n | floor / storey |
| **das Fach** | -(e)s, ⸚er | subject |
| **der Glückspilz** | -es, -e | lucky person |
...
| **die Nahrung** | –, *(rare pl.)* | food / nourishment |
| **das Praktikum** | -s, Praktika | internship |
| **das Schild** | -(e)s, -er | sign / signboard *(≠ der Schild, -e = shield)* |
| **die Schlafmöglichkeit** | –, -en | place to sleep |
| **der Schulhof** | -(e)s, ⸚e | school yard / playground |
| **das Stroh** | -(e)s, *(no pl.)* | straw |
| **das Tor** | -(e)s, -e | gate / goal |
| **die Treppe** | –, -n | stairs |
| **die Unterlagen** | *(pl. only)* | documents / paperwork |
| **die Verabredung** | –, -en | appointment / date |
| **die Verbindung** | –, -en | connection |
| **der Vertrag** | -(e)s, ⸚e | contract |
| **die Wiese** | –, -n | meadow |
| **das Zeichen** | -s, – | sign / symbol |
| **der Ziegel** | -s, – | brick |
...
| **blass** | pale | |
| **dringend** | urgent | |
| **edel** | noble / precious | inflected: *edle, edler, edles* |
| **eigentlich** | actually | |
| **fest** | firm / tight | |
| **friedlich** | peaceful | |
| **gefüllt** | filled | |
| **gespenstisch** | ghostly / eerie | |
| **gleich** | equal / soon | context-dependent |
| **kaum** | hardly | |
| **nämlich** | you see / that is | explains a prior statement |
| **nützlich** | useful | |
| **verschieden** | various / different | |
| **verschollen** | missing (whereabouts unknown) | past-participle adjective |
| **ziellos** | aimless | |
...
| Expression | Meaning |
| :--- | :--- |
| **Schlange stehen** | to queue / stand in line |
| **sich Sorgen machen** | to worry |
| **wie sonst** | as usual |
| **Sie ist anders als sonst.** | She's not herself today. |
